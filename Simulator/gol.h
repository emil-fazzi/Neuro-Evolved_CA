...
int differenze[MAX_DIM][MAX_DIM];
...
int countParticles(int n_particles, int iteration, int dim);
void countDifference(int iteration, int dim);
void clearScreen();
...
int countParticles(int iteration, int dim){
...
int countVar(int n_particles, int iteration){
    int var = 0;

    var = pow((n_particles - (n_particles/iteration+1)), 2);
